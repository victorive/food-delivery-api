...
use App\Http\Requests\V1\Auth\RegisterCustomerRequest;
use App\Http\Requests\V1\Auth\RegisterDeliveryAgentRequest;
use App\Http\Requests\V1\Auth\RegisterRestaurantRequest;
